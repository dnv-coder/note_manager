...
# Добавляем функционал удаления заметок

print("Grade 1. Этап 2: Задание 5")
...
# Цикл для управления добавлением и просмотром заметок, добавляем вариант удаления заметок
while True:
    print("Меню:")
